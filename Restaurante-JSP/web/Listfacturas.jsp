  ...
  <body>
    ...
    <table  class="mt-5 table table-responsive-md  table-striped table-dark">
            <tr>
                ...
                <% while (facturas.next()){ %>
                    <tr>
                        <td><%= facturas.getString("idFactura") %></td>
                        <td><%= facturas.getString("idPedido") %></td>                        
                        <td><%= facturas.getString("fecha") %></td>
                        <td><%= facturas.getString("valorNeto") %></td>
                        <td><%= facturas.getString("valorTotal") %></td>
