...
public class ActualizarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
           p.setIdProducto(Integer.parseInt(request.getParameter("txtId")));
           p.setNombre(request.getParameter("txtNombre"));
           p.setDescripcion(request.getParameter("txtDescripcion"));
           p.setValor(Integer.parseInt(request.getParameter("txtValor")));
           p.setIdCategoria(Integer.parseInt(request.getParameter("txtCategoria")));
           p.setCantidad(Integer.parseInt(request.getParameter("txtCantidad")));
           
           producDB.actualizarMenu(p);
