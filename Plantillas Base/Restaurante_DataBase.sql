...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-03-2020 a las 23:06:55
...
INSERT INTO `productos` (`idProducto`, `nombre`, `descripcion`, `valor`, `estado`) VALUES
(1, 'Panino Caprese', 'Queso bocconcini de búfala, mozzarella, albahaca y tomates secos, con pesto y reducción de balsámico. ', 19500, 1),
(2, 'Bowl Caprese', 'Queso bocconcini de búfala, pasta penne a la napolitana, albahaca y tomates cherry, con aceite de oliva. ', 21000, 1),
(3, 'Bowl Feta', 'Queso bocconcini de búfala o tofu, pasta penne al pesto, maíz, queso feta, ajonjolí, tomates cherry, aguacate y mix de lechugas; con vinagreta campiña.', 20000, 1),
(4, 'Crema de champiñones', 'Crema de champiñones acompañada con pancitos y parmesano. ', 13500, 1),
(5, 'Panino Pollo Carbonara', 'Pollo a la plancha con champiñón portobello y tocineta; cubierto con salsa carbonara y mozzarella. ', 26100, 1),
(6, 'Canelones Ricotta y Espinaca', 'Tres rollos de pasta artesanal, rellenos con espinaca, ricotta y tomates secos, gratinados con salsa blanca, napolitana y parmesano. ', 21600, 1),
(7, 'Bowl Pesto', 'Queso bocconcini de búfala o tofu, cuscús al pesto, tomates cherry, champiñones salteados, zanahorias rostizadas y mix de lechugas; con aderezo ranch. ', 21000, 1);
